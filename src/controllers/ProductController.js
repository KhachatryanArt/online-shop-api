...
class ProductController {
    ...
    static async updateProduct(ctx) {
        ...
        const filePath = ctx.file.destination;
        const {productName, price, description, category} = ctx.request.body;
        ctx.body = await ProductService.updateProduct(productName, price, description, category, filePath, name, id, product_Id)
    ...
    static async deleteProduct(ctx) {
        ...
        ctx.body = await ProductService.deleteProduct(id, user_Id)
    }
